...
D.hat <- EstimateD(A, clique.set, verbose = T)
reference.set <- selectReference(D.hat, J = 5, tri.const = 1.4)


cc.test <- SubSampleConstantCurvatureTest(A, clique.set, reference.set)
